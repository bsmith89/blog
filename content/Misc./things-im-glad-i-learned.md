...
subtitle: Skills, concepts, techniques, and models that have been helpful and/or formative
...
When you have multiple files, and some of them are prerequisites of _other_
files you end up with a directed, acyclic graph describing all of the
...
framework) as well.
While it was a chore to re-frame my mental model of probabilistic programming
...
descent algorithms for MAP estimation have been a breakthrough for me.

I honestly have no idea who first introduced me to PP, but based on my
GitHub I was self-teaching PyMC3 in 2016.
...
I'm a solid Haskell beginner (maybe intermediate depending on who you ask).
I don't do any of my work in Haskell (although I'm often wondering if there are
opportunites).
On the other hand, almost all of my programming is in a functional style.
...
- Use higher-level programming instead of conditionals to control program flow
- Keep side-effects away from core logic

#### Plain-text

Simple text-files and a smattering of UNIX tools will make you like 2/3rds of
a bioinformatician.  
Text files are the ultimate form of portability and should be used until
you have a good reason not to.

#### Version Control (e.g. Git)

If most of your work is plain text, you also get to use version control for
tracking your progress, archiving, sharing, collaboration, and some fancy
branching that sometimes comes in handy.

I think I'm very competent with Git and it's saved my ass many many times.

#### Jupyter notebooks

...but only for prototyping and interactive work; never for reproducible
automation.
...
general discourse.
To my eye, it's all B.S.

Introduced to me by/on: unknown.

#### Spandrils

Not everything that seems adaptive, even when there's evidence for convergent
evolution, actually is.
Some traits are a natural consequence of physical reality.
This is important to more than just snails;
it's probably a part of the answer to e.g. "why do animals have such fancy
microbiomes?"

If I had to guess, I learned about spandrils first in my evolutionary biology
class in college.
...
I learned linear algebra in a course by that name, my sophomore year of college,
...
My introduction to graphical models was really an introduction to maximum
likelihood estimation and structural equation modeling taught by Colin Kremer
and Don Schoolmaster, respectively, during two sessions of ELME ("Enhanced
Linkages between Mathematics and Ecology") at Kellogg Biological Station in the
summer of 2012.
...
I am by no means fully competent with CI, but I aspire to be.
...
is not truly figuring out what I'm trying to teach.
...
is the real win.
Collections of those questions, called concept inventories, can (and should be)
shared as a key component of collaborative lesson development.
...
I see it everywhere and staying self-aware about how it challenges my
...
It feels incredibly powerful to see ones current self as just a single stage
in the development of their full capabilities.
...
- Share your emotional reasons for your beliefs
  ...
  after they and I are vaccinated.
...
- Demonstrate that their community shares that belief.
  ...
  (I think it's really great that our family/college/neighborhood has really
  come together to get everyone vaccinated.)
...
I want everyone to have the same access and opportunities for success and
...
a mutual ability to focus what we say on _our_ needs and feelings instead
of claiming some objective sense of reality.

I can say with some certainty that communication is much more likely to
transition into a fight (not communication) when I break this rule.
...
monopoly power.
For instance doctors have the AMA controlling the supply of medical labor,
Genentech has various patents and corporate secrets, and ISPs have
both cartel power and huge barriers to entry in most regions.

Monopolies aren't all evil (left as an exercise to the reader).
Appropriately regulating these monopolies seems like a key
role of governments.
